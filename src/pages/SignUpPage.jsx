...
export default function SignUpPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    setErrors({});
    setServerErr('');
    const result = await employeeRegister(form.name, form.email, form.password);
    if (!result.ok) {
      setServerErr(result.error || 'An account with this email already exists.');
    } else {
      navigate('/employees');
    }
  };
    ...
    <div className="auth-page signup-page">
      ...
      <div className="auth-center">
        <div className="signup-card animate-scale">
          ...
          <p className="signup-sub">Create your payroll account</p>
